...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; font-size:12px !important; }
  ...
  .comic-strip-wrap { width:100%; height:96mm; border:2px solid #1a1a1a; border-radius:4px; overflow:hidden; background:#fff; display:flex; align-items:center; justify-content:center; }
  .comic-strip-img { width:100%; height:100%; object-fit:contain; display:block; }
