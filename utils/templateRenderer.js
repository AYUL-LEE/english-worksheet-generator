...
// 01_본문노트.html
export function render01_본문노트(data, panelImages = [], pageTitle = '') {
...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; font-size:12px !important; }
  ...
  @page { margin: 10mm; } @media print { body { width:100% !important; margin:0 !important; padding:0 !important; } }
</style>
</head>
<body>
...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; font-size:11px !important; }
  ...
  .english-text { font-size:13px !important; line-height:1.7; font-weight:500; }
  ...
  @page { margin: 10mm; } @media print { body { padding:0 !important; } .sentence-row { break-inside:avoid; margin-bottom:8px; } }
</style>
</head>
<body>
  <div class="header">
...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; font-size:11px !important; }
  ...
  @page { margin: 10mm; } @media print { body { padding:0 !important; } .item { break-inside:avoid; } }
</style>
</head>
<body>
  <div class="header">
...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; font-size:10px !important; }
  ...
  @page { margin: 10mm; } @media print { body { padding:0 !important; } table { break-inside:avoid; } }
</style>
</head>
<body>
  <div class="header">
